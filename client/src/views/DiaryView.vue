...
<template>
  <div class="pt-24 px-5">
    <h2 class="font-jp text-dark text-base font-thin text-center mb-1">私の日記</h2>
  </div>
  <div class="flex flex-col items-center justify-center py-8 px-4">
    <!---カレンダー --->
    <div class="md:p-8 p-5 mb-1 dark:bg-gray-800 bg-white rounded-t">
    ...
    <div class="flex justify-around w-1/2 pb-3 text-center text-sm font-jp text-dark border-b border-dark">
      <div class="flex-non w-2/5">日付</div>
      <div class="flex-non w-1/5">コメント</div>
      <div class="flex-non w-1/5">添削</div>
      <div class="flex-non w-1/5">削除</div>
    </div>
    <div
      v-if="displayDiary"
      class="flex justify-around w-1/2 py-2 text-center text-sm font-jp text-dark border-b border-dark"
    >
      <div class="flex-non w-2/5">{{ }}</div>
      <div class="flex-non w-1/5">{{ }}</div>
      <div class="flex-non w-1/5">{{ }}</div>
      <div class="flex-non w-1/5">
        <button type="button" @click="deleteDiary">
          <img src="@/assets/icons/icon_trash.svg" alt="trash" class="w-5 h-5" />
        </button>
      </div>
    </div>
  </div>
